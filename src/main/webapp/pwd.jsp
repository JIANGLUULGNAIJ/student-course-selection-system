...
<link  rel="stylesheet"  href="${basePath}static/css/styles.css" />
		...
		<script  src="${basePath}static/js/jquery-validation-1.14.0/jquery.validate.min.js" type="text/javascript"></script>
		<script  src="${basePath}static/js/jquery-validation-1.14.0/localization/messages_zh.min.js" type="text/javascript"></script>
</head>
