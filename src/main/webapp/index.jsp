...
<html>
	...
	<body>
		...
		<div class="main">
			...
			<iframe src="https://cn.bing.com/"  width="100%" height="90%" name="mainFrame"  id="mainFrame" frameborder="0px"></iframe>
<%--			<iframe src="query_range.jsp"  width="100%" height="90%" name="mainFrame"  id="mainFrame" frameborder="0px"></iframe>--%>
		</div>
	</body>
</html>
